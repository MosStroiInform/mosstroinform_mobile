...
import 'package:talker_flutter/src/ui/talker_actions/talker_actions.dart';
...
class _TalkerViewState extends State<TalkerView> {
      ...
      builder: (context) {
        return TalkerActionsBottomSheet(
          actions: [
            ...
            TalkerActionItem(
              onTap: () => _shareLogsInFile(context),
  ...
  Future<void> _shareLogsInFile(BuildContext context) async {
